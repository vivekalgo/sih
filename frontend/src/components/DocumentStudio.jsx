...
Confidential Note: Cleared background verification for rental lease.`;
  ...
  return (
    <div className="space-y-4 sm:space-y-6 animate-fade-in max-w-6xl mx-auto flex flex-col">
      ...
      {currentStep === 1 && (
        <div className="glass-card rounded-3xl border border-slate-200/90 dark:border-slate-800 shadow-xl bg-white/95 dark:bg-[#0b0f19]/90 overflow-hidden flex flex-col animate-fade-in">
          ...
          {/* Step Header */}
          <div className="p-4 sm:p-5 pb-3 border-b border-slate-100 dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-900/40 space-y-1">
            <div className="flex items-center justify-between">
              <div className="inline-flex items-center space-x-1.5 px-2.5 py-0.5 rounded-full bg-cyan-50 dark:bg-cyan-950/60 border border-cyan-300 dark:border-cyan-500/30 text-cyan-700 dark:text-cyan-300 text-[11px] font-semibold">
                <Sparkles className="w-3 h-3" />
                <span>Step 1: Intelligent Privacy Engine</span>
              </div>
              <span className="text-[11px] text-slate-400 font-medium hidden sm:inline">
                Tailored for Indian Regulations & Global PII Standards
              </span>
            </div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Select your use case. We automatically suggest what data is safe to keep vs what to hide.
            </p>
          </div>

          {/* Scrollable Purpose Grid Container (Fits nicely on mobile without scrolling whole page) */}
          <div className="p-3.5 sm:p-5 overflow-y-auto max-h-[calc(100dvh-290px)] sm:max-h-[460px] space-y-3">
              ...
              {purposeOptions.map((opt) => {
                ...
                return (
                  <div
                    ...
                    className={`p-3.5 sm:p-4 rounded-2xl border text-left cursor-pointer transition-all duration-200 relative flex flex-col justify-between group ${
                      isSelected
                        ? 'bg-gradient-to-br from-cyan-50 to-blue-50/80 dark:from-cyan-950/70 dark:to-slate-900 border-cyan-500 text-slate-900 dark:text-white shadow-md ring-2 ring-cyan-500/40'
                  ...
                  >
                    <div className="space-y-1.5">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] sm:text-[11px] font-medium text-cyan-700 dark:text-cyan-300">
                          {opt.desc}
                        </p>
                      </div>
          ...
          {/* DOCKED / STICKY BOTTOM ACTION BAR (Always visible without scrolling!) */}
          <div className="p-3.5 sm:p-4 bg-slate-50/95 dark:bg-[#0c101a]/95 backdrop-blur-md border-t border-slate-200/90 dark:border-slate-800 flex items-center justify-between gap-3 sticky bottom-0 z-20">
            ...
            <button
              ...
              className="w-full sm:w-auto ml-auto px-6 sm:px-8 py-3 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold text-xs sm:text-sm shadow-lg shadow-cyan-600/25 flex items-center justify-center space-x-2 transition-all hover:scale-[1.01]"
            >
      ...
      {currentStep === 2 && (
        <div className="glass-card rounded-3xl border border-slate-200/90 dark:border-slate-800 shadow-xl bg-white/95 dark:bg-[#0b0f19]/90 overflow-hidden flex flex-col animate-fade-in max-w-4xl mx-auto w-full">
          ...
          {/* Step Header */}
          <div className="p-4 sm:p-5 pb-3 border-b border-slate-100 dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-900/40 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div>
          ...
          <div className="p-4 sm:p-5 overflow-y-auto max-h-[calc(100dvh-290px)] sm:max-h-[460px] space-y-4">
            ...
            {activeUploadTab === 'file' && (
              <div
                ...
                className={`border-2 border-dashed rounded-2xl p-6 sm:p-8 text-center cursor-pointer transition-all duration-200 relative group ${
                  isDragOver
              ...
              >
                ...
                <div className="space-y-3 max-w-sm mx-auto">
                  <div className="w-12 h-12 rounded-xl bg-cyan-500/10 border border-cyan-500/30 flex items-center justify-center mx-auto text-cyan-600 dark:text-cyan-400 group-hover:scale-105 transition-transform">
                    {isProcessing ? (
                  ...
                  {isProcessing && (
                    <div className="space-y-1.5 pt-1 max-w-xs mx-auto">
            ...
            <div className="p-3 rounded-xl bg-slate-100/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-400 flex flex-col sm:flex-row items-center justify-between gap-2 text-center sm:text-left">
      ...
      {currentStep === 3 && uploadResult && (
        <div className="glass-card rounded-3xl border border-slate-200/90 dark:border-slate-800 shadow-xl bg-white/95 dark:bg-[#0b0f19]/90 overflow-hidden flex flex-col animate-fade-in max-w-5xl mx-auto w-full">
          ...
          <div className="p-4 sm:p-5 pb-3 border-b border-slate-100 dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-900/40 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            ...
            <span className="text-xs text-cyan-600 dark:text-cyan-400 font-semibold px-2.5 py-1 rounded-full bg-cyan-50 dark:bg-cyan-950/70 border border-cyan-300 dark:border-cyan-700/50 w-fit">
              Policy: {purpose || 'General Sharing'}
            </span>
          </div>

          {/* Masking Options Scroll Container */}
          <div className="p-3.5 sm:p-5 overflow-y-auto max-h-[calc(100dvh-290px)] sm:max-h-[460px] space-y-4">
                ...
                {maskingStrategies.map((strat) => {
                  ...
                  return (
                    <button
                      ...
                      className={`text-left p-3 rounded-2xl border text-xs transition-all relative flex flex-col justify-between ${
                        isSelected
                          ? 'border-cyan-500 bg-cyan-50 dark:bg-cyan-950/70 text-cyan-950 dark:text-cyan-100 shadow-sm ring-2 ring-cyan-500/30'
                    ...
                    >
                      <div>
                        ...
                        <div className="text-[10px] font-mono text-cyan-700 dark:text-cyan-300 font-semibold bg-white/70 dark:bg-black/40 px-1.5 py-0.5 rounded border border-cyan-200 dark:border-cyan-800/60 truncate">
                          {strat.desc}
                        </div>
                      </div>
                    </button>
            ...
            {/* 3. Custom Keywords */}
            <div className="rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm bg-white dark:bg-slate-900/60">
              <button
                type="button"
                onClick={() => setShowAdvanced((prev) => !prev)}
                className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900/60 flex items-center justify-between text-xs font-bold text-slate-700 dark:text-slate-300"
              >
              ...
              {showAdvanced && (
                <div className="p-3.5 space-y-3 bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 text-xs">
                  <form onSubmit={handleAddKeyword} className="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      className="px-3.5 py-2 bg-cyan-600 hover:bg-cyan-500 text-white rounded-xl text-xs font-semibold flex items-center space-x-1 transition-all disabled:opacity-40"
                    >
                  ...
                  {customKeywords.length > 0 && (
                    <div className="flex flex-wrap gap-1.5 pt-1">
                      {customKeywords.map((kw) => (
                        <span
                          key={kw}
                          className="inline-flex items-center space-x-1.5 px-2 py-0.5 rounded-lg bg-cyan-50 dark:bg-cyan-950/60 border border-cyan-300 dark:border-cyan-500/40 text-cyan-800 dark:text-cyan-300 text-xs font-semibold"
                        >
                          <span>{kw}</span>
                          <button
                            type="button"
          ...
          <div className="p-3.5 sm:p-4 bg-slate-50/95 dark:bg-[#0c101a]/95 backdrop-blur-md border-t border-slate-200/90 dark:border-slate-800 flex items-center justify-between gap-3 sticky bottom-0 z-20">
            ...
            <button
              ...
              className="px-6 sm:px-8 py-3 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold text-xs sm:text-sm shadow-lg shadow-cyan-600/25 flex items-center justify-center space-x-2 transition-all hover:scale-[1.01]"
            >
        ...
        <div className="space-y-4 animate-fade-in">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-3.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl text-xs text-slate-700 dark:text-slate-300 shadow-sm">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span>Sharing For: <strong className="text-cyan-700 dark:text-cyan-300 font-semibold">{purpose || uploadResult.purpose || 'General Sharing'}</strong></span>
              <span className="text-slate-300 dark:text-slate-700">•</span>
              ...
              <div className="glass-card rounded-2xl p-4 border border-slate-200 dark:border-slate-800 space-y-3 shadow-lg bg-white dark:bg-slate-900/80">
                ...
                {previewPages.length > 0 ? (
                  <div
                    ...
                    className="rounded-xl overflow-y-auto max-h-[500px] p-3 space-y-4 bg-slate-100/70 dark:bg-[#07090f] border border-slate-200 dark:border-slate-800 shadow-inner"
                  >
                  ...
                  <div className="p-4 bg-slate-50 dark:bg-slate-950 rounded-xl font-mono text-xs text-slate-800 dark:text-slate-200 whitespace-pre-wrap max-h-[460px] overflow-y-auto">
